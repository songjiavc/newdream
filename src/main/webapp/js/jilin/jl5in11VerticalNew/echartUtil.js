 ...
 */
    ...
    function getMoveLast(){
    	...
    	$('#dataTable,#canvasMain').css('marginTop',-(paramObj.clientPix+paramObj.linePx)*(paramObj.addCount));
       	layoutControlDiv(['#dataTable','#canvasMain']);
    }
    ...
    function layoutControlDiv(tableIds){
	   ...
	   /*
         ...
         */
         ...
         trCenterJo.append($("<td><img src='img/util/left.png' id='left' onMouseOut='changeOutCss(this)' width='80' height='80' onmouseover='changeOverCss(this)' /></td>")).append($("<td><img src='img/util/center.png' id='center' onMouseOut='changeOutCss(this)' width='80' height='80' onclick='moveLast(\""+tableIds+"\")' onmouseover='changeOverCss(this)' /></td>")).append($("<td><img src='img/util/right.png' id='right' onMouseOut='changeOutCss(this)' width='80' height='80' onclick='moveRight()' onmouseover='changeOverCss(this)' /></td>"));
    ...
    function moveRight(){
    	window.open("http://192.168.1.203:8080/echart3/hlj5in11VerticalExtendController/hljExtend.do","_self");
    }
